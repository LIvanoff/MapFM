...
class HeightKernelAttention(BaseModule):
    ...
    def __init__(self,
        ...
        super(HeightKernelAttention, self).__init__(init_cfg)
        ...
        self.height_range = pc_range[5] - pc_range[2]
    ...
    def init_weight(self):
        ...
        constant_init(self.height_offsets, 0.0)
    ...
    @force_fp32(apply_to=('query', 'key', 'value', 'query_pos', 'reference_points_cam',
                          'reference_points', 'sampled_heights'))
    def forward(self,
                query,
                key,
                value,
        ...
        sampled_heights = self.height_offsets(query)
        ...
        # check_tensor(reference_points_cam, "reference_points_cam")
        # check_tensor(bev_mask, "bev_mask")
        ...
        # check_tensor(queries_rebatch, "queries_rebatch")
        reference_points_rebatch = reference_points_cam.new_zeros(
            [bs, self.num_cams, max_len, D, 2])
        # check_tensor(reference_points_rebatch, "reference_points_rebatch")
        # print("reference_points_rebatch min/max", reference_points_rebatch.min(), reference_points_rebatch.max())
...
@ATTENTION.register_module()
class MSDeformableAttentionKernel(BaseModule):
    ...
    def forward(self,
        ...
        sampling_offsets = self.grid_offsets.repeat(bs, num_query, self.num_heads, self.num_levels, 1, 1)
