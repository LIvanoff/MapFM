...
We provide all the visualization scripts under `/path/to/MapFM/tools/maptr/`

## Visualize prediction

```shell
cd /path/to/MapFM/
export PYTHONPATH="/path/to/MapFM/"
...
- All the visualization samples will be saved in `/path/to/MapFM/work_dirs/experiment/vis_pred/` automatically. If you want to customize the saving path, you can add `--show-dir /customized_path`.
...
```
**Notes**: 
- The video will be saved in `/path/to/MapFM/work_dirs/experiment/`